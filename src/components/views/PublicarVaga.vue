<template>
  <div class="container py-4">
    <div class="row">
      <div class="col">
        <h4>Aresente a sua vaga para milhares de profissionais e de graça</h4>
      </div>
    </div>
    ...
    <div class="row mt-3">
      ...
      <div class="col">
        <button type="submit" class="btn bn-primary" @click="salvarVaga()">Cadastrar</button>
      </div>
    </div>
  ...
  methods: {
    salvarVaga() {
      ...
      vagas.push({
        ...
        tipo: this.tipo,
        publicacao: dataAtual.toLocaleDateString()
      })
